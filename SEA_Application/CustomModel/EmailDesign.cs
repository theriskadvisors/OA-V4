...
template +="</body>";
        ...
        public static string StudentAssignementSubmittedTemplate(string TeacherName, string SubjectName, string ClassName, string LessonName, string StudentName)
        {
            string template = "";
            ...
            template += "<tr style='direction:ltr'>";
            template += "<td style='direction:ltr;width:36px' width='36'>";
            template += "<img alt='person' height='36' src='https://lh3.googleusercontent.com/a-/AAuE7mAGg12HORpLlqtFcCn3HxXbiIWXVbMZ2scNL9VSWA%3Ds96-c' style='direction:ltr;border:0;border-radius:0px;display:block;outline:none;text-decoration:none;height:36px;width:100%' width='36' class='CToWUd'>";
            template += "</td>";
            template += "</tr>";
            template += "</tbody>";
            template += "</table>";
            ...
            template += "<tbody><tr style='direction:ltr'>";
            template += "<td align='left' style='direction:ltr;font-size:0px;padding:0px;word-break:break-word'>";
            template += "<div style='direction:ltr;padding-bottom:10px;font-family:Helvetica Neue,Helvetica,Arial,sans-serif;font-size:18px;font-weight:500;line-height:30px;text-align:left;color:#000000'> Comment Posted </div>";
            template += "</td>";
            template += "</tr>";
            template += "<tr style='direction:ltr'>";
            template += "<td align='left' style='direction:ltr;font-size:0px;padding:0px;word-break:break-word'>";
            template += "<div style='direction:ltr;font-family:Helvetica Neue,Helvetica,Arial,sans-serif;font-size:16px;font-weight:300;line-height:150%;text-align:left;color:#333333'> Comment has been posted by  '" + StudentName + "'<br>  Subject: " + SubjectName + " <br>  Class: " + ClassName + " <br> Lesson: " + LessonName + " <br><br> Thanks </div>";
            template += "</td>";
            template += "</tr>";
            template += "</tbody></table>";
            template += "</td>";
